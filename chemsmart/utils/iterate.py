...
#      via a CLI algorithm subcommand ('yaml jlgo', 'yaml etkdg').
#
...
# === Algorithm layer (optional; default is etkdg) ===
algorithm:
  name: etkdg                     # or 'jlgo'
  options:
    # RDKit ETKDGv3 embedding; local mode keeps the skeleton fixed.
  ...
  # --- JLGO (Joint Lagrange Geometry Optimization) ---
  # name: jlgo
  # options:
  #   quality_mode: strict          # strict / warn / "off" (quote in YAML)
  #   # warn exports a hard-feasible candidate if quality search fails.
  #   # off skips quality rejection/repair; metrics remain in the report.
